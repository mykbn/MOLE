...
$create_card_query = "INSERT INTO `".$subj."_cards` (ID, List, CardTitle, Description, Created_By, Date_Created) VALUES (NULL, '$list', '$quizTitle', 'Quiz', '".$_SESSION['REALNAME']."', '$date')";
